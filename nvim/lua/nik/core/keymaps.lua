...
keymap.set("n", "<leader>gt", "<cmd>Telescope git_status<cr>") -- list current changes per file with diff preview ["gs" for git status]

-- fugitive
keymap.set("n", "<leader>gs", "<CMD>G<CR>")
keymap.set("n", "<leader>gq", "<CMD>G<CR><CMD>q<CR>")
